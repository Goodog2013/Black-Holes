...
const I18N = {
  ru: {
    ...
    vrNoRuntime: 'VR-шлем не обнаружен.\n\nЧек-лист для Quest Link (ПК):\n1. Приложение Meta Quest Link запущено, шлем подключён (кабель/Air Link) и Link активен в шлеме.\n2. В настройках приложения: Settings → General → OpenXR Runtime = Meta Quest Link.\n3. Браузер Chrome или Edge (не Firefox).\n4. Перезапустите браузер после запуска Link.',
    vrFail: 'Не удалось запустить VR-сессию.',
  ...
  en: {
    ...
    vrNoRuntime: 'No VR headset detected.\n\nQuest Link (PC) checklist:\n1. Meta Quest Link app is running, headset connected (cable/Air Link) and Link active in the headset.\n2. In the app: Settings → General → OpenXR Runtime = Meta Quest Link.\n3. Use Chrome or Edge (not Firefox).\n4. Restart the browser after starting Link.',
    vrFail: 'Failed to start the VR session.',
